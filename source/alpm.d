...
alias alpm_delta_t = _alpm_delta_t;
...
alias alpm_event_delta_patch_t = _alpm_event_delta_patch_t;
...
alias alpm_db_usage_t = _alpm_db_usage_;
...
int alpm_extract_keyid(alpm_handle_t* handle, const(char)* identifier,
                const(ubyte)* sig, const size_t len, alpm_list_t** keys);
...
alpm_pkg_t* alpm_find_dbs_satisfier(alpm_handle_t* handle, alpm_list_t* dbs,
